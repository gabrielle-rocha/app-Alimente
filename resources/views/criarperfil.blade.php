    ...
    <div class="left-section">
        <div class="profile-card">
            ...
            <div class="causes-section">
                <img src="https://via.placeholder.com/50x50" alt="Causa 1">
                <img src="https://via.placeholder.com/50x50" alt="Causa 2">
                <img src="https://via.placeholder.com/50x50" alt="Causa 3">
                <img src="https://via.placeholder.com/50x50" alt="Causa 4">
            </div>
            <button type="submit" class="btn btn-next">Próximo</button>
        </div>
    </div>
    <div class="right-section">
        <img src="image-path.png" alt="Alimente - Gerando Solidariedade">
    </div>
</body>
</html>